...
$Header: //commercial/MPSS.TA.2.1.c1/Main/modem_proc/uim/pbm/src/pbm.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/12/15   stv     Deprecate usage of TASK_HANDLE
04/06/15   stv     Migrate some efs access to uim_common_efs API
...
extern rex_tcb_type     * pbm_tcb_ptr;

#define PBM_TCB  pbm_tcb_ptr
